...
public class TestSrc {
	...
	public static void screenshotCapture(WebDriver driver, String fileNameToBe)
	{
		...
		try {
			...
			FileUtils.copyFile(file, new File("C:\\Users\\Dell\\eclipse-workspace\\Demoproject\\Selenium1\\src\\test\\java\\captureScreenShot\\screenshots\\CptSs.java" + fileNameToBe + ".jpg"));
