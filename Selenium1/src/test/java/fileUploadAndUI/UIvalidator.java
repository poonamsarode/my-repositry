...
WebDriver driver ;
 ...
 final String loginBtnFontSz = "20px";
	...
	public void validateFontSize () throws InterruptedException
	{
		...
		WebElement loginBtn  = driver.findElement(By.xpath("//button[@name='login']"));
		System.out.println("the font size for the login button " + loginBtn.getCssValue("font-size") );
	
	//	String actualLoginBtnFontSz = loginBtn.getCssValue("font-size");
	...
	//	System.out.println("After conversion of rgba color to hex code O/P is ->" +  haxfontSzOfLoginBtn );
		...
		Assert.assertEquals(loginBtnFontSz,rgbaTaHexVal( loginBtn.getCssValue("font-size")));
		
	}
		
   /**
    *  This method convert the RGB value to HEX code 
    * @param rgbaValue
    * @return
    */
	
	public static String  rgbaTaHexVa(String rgbaValue)
	{
		return Color.fromString(rgbaValue).asHex();
	}
